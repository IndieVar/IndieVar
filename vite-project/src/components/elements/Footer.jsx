...
const navigation = {
    social: [
        {
            name: 'Facebook',
            href: 'https://www.facebook.com/aleksandr.varlamov.102/',
            icon: (props) => (
        ...
        {
            name: 'GitHub',
            href: 'https://github.com/IndieVar',
            icon: (props) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
...
export default function Footer() {
    ...
    return (
        <>
            ...
            <footer className="absolute z-20 bg-white mx-auto max-w-7xl inset-x-0 px-6 pb-8 sm:px-16 xl:px-8"
                    aria-labelledby="footer-heading">
                <div className={"flex justify-center border-t border-gray-900/10 pt-6"}>
                    <ContactFormBtn setIsOpen={setIsOpenContactForm}/>
                </div>
                <div className="pt-6 lg:flex lg:items-center lg:justify-between">
                    <div>
